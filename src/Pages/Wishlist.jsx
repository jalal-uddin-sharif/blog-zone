...
console.log(list);
    ...
    return (
        <div className="container mx-auto">
            ...
            {/* card */}
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 md:grid-cols-3">

            {
                list?.map(data =>(
                <div key={data._id}  className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">

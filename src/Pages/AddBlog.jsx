                ...
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    ...
                    <form onSubmit={handleForm} className="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <input required name="shortDescription" maxLength="180" className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                        </div>

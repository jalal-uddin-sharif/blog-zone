                        ...
                        <div>
                            ...
                            name="Category"
                             class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <option value="Apps Review">Apps review</option>
                            </select>
                        </div>

                        <div className="sm:col-span-2">
                            <label for="shortDescription" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Short description</label>
                            <input required name="shortDescription" maxLength="140" className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                        </div>

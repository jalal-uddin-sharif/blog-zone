  ...
  return (
    <div className="h-40  animated-background bg-gradient-to-r from-blue-500 via-blue-500 to-indigo-500">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col gap-2 lg:flex-row justify-between items-center  mt-4">
          ...
          <div className="flex  justify-center items-center text-center" style={{ direction: "" }}>

            {
              user ?
                <div>
                  <h1>Welcome! <span className="text-yellow-200">{user?.displayName?.split(" ")[0]}</span></h1>
                  <p className="text-sm ">We're delighted to have you here.</p>
                </div>
                :
                <div className="flex  gap-4">

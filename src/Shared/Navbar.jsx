      ...
      <div className="container mx-auto">
        ...
        <div className="flex justify-between items-center  mt-8">
          ...
          <div className="flex justify-center items-center" style={{ direction: "rtl" }}>
            ...
            <div className="flex gap-4">
            <a href="#_" className="relative text-xs  items-center justify-center inline-block p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group">
